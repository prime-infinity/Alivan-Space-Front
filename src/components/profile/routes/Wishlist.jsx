          ...
          <div className="cart-item">
            <div className="row d-flex align-items-center text-start text-md-center">
              <div className="col-12 col-md-5">
                <a className="cart-remove close mt-3 d-md-none">
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-md-3">
                    <div className="row">
                      <div className="col-6 d-md-none text-muted">Status </div>
                      <div className="col-6 col-md-12 text-end text-md-start">
                        <div className="badge p-lg-2 badge-danger-light">
                          Out of stock
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 d-none d-md-block text-center"></div>
                  <div className="col-1 d-none d-md-block text-center">
                    <a className="cart-remove text-muted">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-md-3">
                    <div className="row">
                      <div className="col-6 d-md-none text-muted">Status </div>
                      <div className="col-6 col-md-12 text-end text-md-start">
                        <div className="badge p-lg-2 badge-info-light">
                          Being restocked
                        </div>
                      </div>
                    </div>
