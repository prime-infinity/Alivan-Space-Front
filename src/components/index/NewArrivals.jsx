function NewArrivals() {
    return ( 
        ...
        <div className="text-center">
            <h2>New Arrivals</h2>
            <p className="lead text-muted mb-5">One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed and divided by arches into stiff sections</p>
        </div>
                ...
                <div className="row">
                    ...
                    <div className="detail-carousel">
                        ...
                        <div className="swiper-wrapper">
                            {/* Slides*/}
                            <div className="swiper-slide"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-1-gray.jpg" alt="Modern Jacket 1" /></div>
                            <div className="swiper-slide"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-2-gray.jpg" alt="Modern Jacket 2" /></div>
                            <div className="swiper-slide"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-3-gray.jpg" alt="Modern Jacket 3" /></div>
                            <div className="swiper-slide"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-4-gray.jpg" alt="Modern Jacket 4" /></div>
                            <div className="swiper-slide"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-5-gray.jpg" alt="Modern Jacket 5" /></div>
                        </div>
                        </div>
                        <div className="swiper-thumbs" data-swiper="#quickViewSlider">
                        <button className="swiper-thumb-item detail-thumb-item mb-3 active"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-1-gray.jpg" alt="Modern Jacket 0" /></button>
                        <button className="swiper-thumb-item detail-thumb-item mb-3"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-2-gray.jpg" alt="Modern Jacket 1" /></button>
                        <button className="swiper-thumb-item detail-thumb-item mb-3"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-3-gray.jpg" alt="Modern Jacket 2" /></button>
                        <button className="swiper-thumb-item detail-thumb-item mb-3"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-4-gray.jpg" alt="Modern Jacket 3" /></button>
                        <button className="swiper-thumb-item detail-thumb-item mb-3"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/varkala/2-1/img/product/detail-5-gray.jpg" alt="Modern Jacket 4" /></button>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="d-flex flex-column flex-sm-row align-items-sm-center justify-content-sm-between mb-4">
                        ...
                        </ul><span className="text-muted text-uppercase">25 reviews</span>
                        </div>
                    </div>
                    ...
                    <form id="buyForm_modal" action="#">
                        ...
                        <div className="col-sm-6 col-lg-12 detail-option mb-4">
                            ...
                            <select className="selectpicker" name="size" data-style="btn-selectpicker">
                        ...
                        <div className="col-sm-6 col-lg-12 detail-option mb-5">
                            ...
                            <label className="btn btn-sm btn-outline-primary detail-option-btn-label" htmlFor="material_0_modal"> Hoodie
                            <input className="input-invisible" type="radio" name="material" defaultValue="value_0" id="material_0_modal" required="" />
                            </label>
                            <label className="btn btn-sm btn-outline-primary detail-option-btn-label" htmlFor="material_1_modal"> College
                            <input className="input-invisible" type="radio" name="material" defaultValue="value_1" id="material_1_modal" required="" />
                            </label>
                        </div>
                        </div>
                        <div className="input-group w-100 mb-4">
                        <input className="form-control form-control-lg detail-quantity" name="items" type="number" defaultValue="1" />
                        <div className="flex-grow-1">
                            <div className="d-grid h-100">
                            <button className="btn btn-dark" type="submit"> <i className="fa fa-shopping-cart me-2"></i>Add to Cart</button>
                            </div>
                        </div>
                        </div>
